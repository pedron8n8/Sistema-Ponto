...
## Corpus Check
- 151 files · ~145,390 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1482 nodes · 2831 edges · 82 communities (75 shown, 7 thin omitted)
...
- `adjustUserBankHours()` --calls--> `adjustBankHours()`  [EXTRACTED]
...
### Community 5 - "App.tsx"
Cohesion: 0.09
Nodes (29): App(), LoadingScreen(), LoadingScreenProps, Props, ProtectedRoute(), ShellLayout(), useAuth(), PLAN_LEVELS (+21 more)
...
Cohesion: 0.09
Nodes (28): fmtHM(), JourneyModal(), ModalEntry, Props, buildTimeline(), JourneyEntry, Segment, AdminPendingApprovalsPage() (+20 more)
...
Cohesion: 0.17
Nodes (27): buildOrgTeamWhere(), canManageTarget(), createHrEntry(), deleteHrEntry(), formatMinutes(), getHrDaily(), getHrTeam(), getHrUserDaily() (+19 more)

### Community 17 - "vacation.controller.js"
Cohesion: 0.15
Nodes (28): ACTIVE_VACATION_STATUSES, { buildUserPhotoUrl }, canReviewVacationWithinTenant(), createVacationRequest(), encodeVacationReasonWithType(), endOfDay(), getHrVacationRequests(), getMyVacationRequests() (+20 more)
...
Cohesion: 0.10
Nodes (18): authMiddleware, requirePlan, roleCheck, { authMiddleware, roleCheck, requirePlan }, express, router, timeController, { authMiddleware, roleCheck, requirePlan } (+10 more)

### Community 20 - "ShellLayout.tsx"
Cohesion: 0.11
Nodes (13): BrandWordmark(), BrandWordmarkProps, joinClassNames(), LanguageSwitcher(), LanguageSwitcherProps, normalizeLanguage(), NavItem, NavSection (+5 more)

### Community 21 - "consent.ts"
Cohesion: 0.16
Nodes (22): CookieConsentBanner(), applyConsent(), disableAnalytics(), injectGoogleAnalytics(), measurementId, removeNode(), acceptAll(), CONSENT_EVENT (+14 more)
...
Cohesion: 0.12
Nodes (21): { accrueBankHours, expireBankHoursIfNeeded }, buildDefaultFaceAuth(), buildDefaultPinAuth(), { calculateDuration, getStartOfDay, getEndOfDay }, {
...
Cohesion: 0.16
Nodes (20): adjustTeamMemberBankHours(), approveEntriesBulk(), approveEntry(), approveOvertime(), buildManagedTeamWhere(), canManageTeamUser(), getEntryDetails(), getTeamBankHoursOverview() (+12 more)
...
Cohesion: 0.16
Nodes (15): apiFetch(), AdminCheckoutThankYouPage(), HrGroupsPage(), isManageableRole(), MANAGEABLE_ROLES, ManageableRole, Role, User (+7 more)
...
### Community 38 - "VacationSupervisorPage.tsx"
Cohesion: 0.18
...
Cohesion: 0.21
Nodes (12): getMyBankHours(), accrueBankHours(), addMonths(), adjustBankHours(), clampPositiveInteger(), expireBankHoursIfNeeded(), { prisma }, settleBankHoursAccruals() (+4 more)
...
### Community 45 - "upload.middleware.js"
Cohesion: 0.19
...
Cohesion: 0.29
Nodes (12): getCurrentEntry(), getMyTimeEntries(), getTimeEntryById(), getTodayEntries(), resolveBreakMinutes(), resolveStoredBreakMinutes(), resolveWorkedMinutes(), resumeBreak() (+4 more)
...
Cohesion: 0.28
Nodes (6): Language, LanguageContext, LanguageContextState, LanguageProvider(), normalizeLanguage(), toI18nLanguage()

### Community 59 - "clockOut"
Cohesion: 0.39
Nodes (8): buildLocationPayload(), calculateFinancialSummary(), clockIn(), clockOut(), getGeofenceErrorMessage(), getQrErrorMessage(), resolveLocationValidationSource(), emitPunch()
...
### Community 61 - "rateLimit.middleware.js"
Cohesion: 0.32
...
## Knowledge Gaps
- **618 isolated node(s):** `node`, `es2021`, `eslint:recommended`, `ecmaVersion`, `sourceType` (+613 more)
...
- **Why does `prisma` connect `database.js` to `pro.controller.js`, `reportWorker.js`, `auth.routes.js`, `publicApi.controller.js`, `proactiveAlertWorker.js`, `slack.controller.js`, `recalcDay.js`, `supervisor.controller.js`, `user.controller.js`, `admin.controller.js`, `hr.controller.js`, `vacation.controller.js`, `finance.controller.js`, `time.controller.js`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `App.tsx` to `SuperAdminAccountsPage.tsx`, `apiFetch`, `VacationSupervisorPage.tsx`, `api.ts`, `Reports.tsx`, `SupervisorPendingItemsPage.tsx`, `HrSchedulesPage.tsx`, `HrDailyTimePage.tsx`, `ShellLayout.tsx`, `AdminFinancePage.tsx`, `SupervisorDashboard.tsx`, `ColaboradorDashboard.tsx`, `AdminDashboard.tsx`, `AuthContext.tsx`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `apiFetch()` connect `apiFetch` to `SuperAdminAccountsPage.tsx`, `App.tsx`, `VacationSupervisorPage.tsx`, `api.ts`, `Reports.tsx`, `SupervisorPendingItemsPage.tsx`, `HrSchedulesPage.tsx`, `HrDailyTimePage.tsx`, `AdminFinancePage.tsx`, `ShellLayout.tsx`, `SupervisorDashboard.tsx`, `ColaboradorDashboard.tsx`, `AdminDashboard.tsx`, `AuthContext.tsx`?**
