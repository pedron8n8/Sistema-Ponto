...
- [X] **A-02** Registro via QR Code dinâmico por terminal
...
- [X] **A-03** Funcionamento offline no app mobile
...
- [X] **D-02** KPIs de horas: previsto x realizado x extras
  ...
  - **Tags:** `frontend`
- [X] **D-03** Alertas proativos de custo de horas extras
  ...
  - **Tags:** `backend`
- [X] **D-04** Mapa de colaboradores externos
