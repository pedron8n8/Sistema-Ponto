...
const { buildDailyLogs: buildDailyLogsWithPayment } = require('../../src/workers/reportWorker');

// O pagamento vem de computeEntryPayments; aqui so interessa a coluna de
// minutos reconhecidos, entao o mapa vai vazio (entry sem pagamento paga 0).
const buildDailyLogs = (entries) => buildDailyLogsWithPayment(entries, new Map());
